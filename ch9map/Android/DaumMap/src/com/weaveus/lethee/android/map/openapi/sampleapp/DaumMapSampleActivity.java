package com.weaveus.lethee.android.map.openapi.sampleapp;
...
public class DaumMapSampleActivity extends Activity 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapView.setDaumMapApiKey("32e0df13274cc8063cae6b4e64b20c1e80106140");
		...
		case MENU_LOCATION_TRACKING:
		{
			...
			dialog.setItems(mapMoveMenuItems, new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					{
						reverseGeoCoder = new MapReverseGeoCoder("32e0df13274cc8063cae6b4e64b20c1e80106140", mapView.getMapCenterPoint(), DaumMapSampleActivity.this, DaumMapSampleActivity.this);
