...
package com.weaveus.lethee.mapp.map;
...
public class NMapViewer extends NMapActivity {
	...
	// Application name which uses NMapViewer library.
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// set your application name for Open MapViewer Library
		mMapView.setAppName(APP_NAME);
		mMapView.setApiKey("f8a0e75425b1255adebabeec5d7a373c");
